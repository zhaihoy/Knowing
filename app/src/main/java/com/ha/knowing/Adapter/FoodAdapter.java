...
public class FoodAdapter extends BaseRecyclerAdapter<MeizhiBean.ResultsBean> {
    @Override
    public CommonHolder<MeizhiBean.ResultsBean> setViewHolder(ViewGroup parent) {
        return new CardHolder(parent.getContext(), parent);
    }

    class CardHolder extends CommonHolder<MeizhiBean.ResultsBean> {
        ...
        @Override
        public void bindData(MeizhiBean.ResultsBean food) {
