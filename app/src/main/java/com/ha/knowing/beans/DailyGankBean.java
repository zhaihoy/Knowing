...
public class DailyGankBean implements Serializable {
    ...
    private MeizhiBean.ResultsBean results;
    ...
    public MeizhiBean.ResultsBean getResults() {
        return results;
    }

    public void setResults(MeizhiBean.ResultsBean results) {
